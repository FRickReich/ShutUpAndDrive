...
public class SaveLoad: MonoBehaviour{
	...
	{
		if (File.Exists(Application.persistentDataPath + "/QuestList.stad"))
		{
			BinaryFormatter bf = new BinaryFormatter();
			FileStream stream = new FileStream(Application.persistentDataPath + "/QuestList.stad", FileMode.Open);
