...
namespace Game.Modules.QuestSystem.v1_0
{
	[ExecuteInEditMode]
public class QuestManager : MonoBehaviour {
	...
	//Upate Running quests when removing items from Inventory for Example - Item name and amount is needed
	public void RemoveItem(int itemAmount, string itemName)
	{
		for (int i = 0; i < currentQuestList.Count; i++)
		{
