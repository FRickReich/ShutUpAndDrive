...
namespace Game.Managers
{
	public class Invantory : MonoBehaviour
	{
		...
		void Start()
		{
			...
			invantoryObjectTemplate = GameObject.Find("InventoryTemplate");
		...
		private void OnEnable()
		{
            ...
            inputControls.Character.NextItem.performed += context => NextItem();
			inputControls.Character.PrevItem.performed += context => PrevItem();
			inputControls.Character.UseItem.performed += context => UseSelectedItem();
		...
		private void InitGUI()
		{
			...
			for (int i = 0; i < invantorySlots.Count; ++i)
			{
				...
				invantorySlots[i].GetComponent<InvantorySlot>().owningInventory = this;
