...
public class InputSystemTester : MonoBehaviour
{
    ...
    //public Game.InputMaster controls;
	...
	void Start()
    {
        ...
        switch(characterTestState)
        {
            case CharacterTestState.CHARACTER:
                inputControls.Character.Shoot.performed += context => CharacterShoot();
                ...
                inputControls.Character.Move.performed += context => CharacterMove(context.ReadValue<Vector2>());
                inputControls.Character.Rotate.performed += context => CharacterRotate(context.ReadValue<Vector2>());
            ...
            case CharacterTestState.VEHICLE:
                inputControls.Vehicle.HandBrake.performed += context => VehicleHandbrake();
